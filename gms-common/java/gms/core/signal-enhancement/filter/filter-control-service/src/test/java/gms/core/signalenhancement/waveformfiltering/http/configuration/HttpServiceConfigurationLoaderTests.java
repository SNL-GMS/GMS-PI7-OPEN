...
public class HttpServiceConfigurationLoaderTests {
  ...
  @Before
  public void setUp() {
    final String propertyFile = "gms/core/signalenhancement/waveformfiltering/http/application.properties";
  ...
  public void testLoadConfiguration() {
    ...
    assertEquals("/signal-enhancement/waveform-filtering-test-base/", config.getBaseUrl());
