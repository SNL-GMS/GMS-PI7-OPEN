...
import gms.core.signalenhancement.beam.util.ConfigurationLoader;
import java.net.URL;
...
/**
 * Creates {@link HttpClientConfiguration} from a hierarchy of Environment variables System
 ...
 */
// TODO: rewrite to use configuration mechanism
public class HttpClientConfigurationLoader {
   ...
   *
   * Required configuration keys and value types are: host, string port, integer baseUrl, string
   *
