...
/**
 * HttpServiceConfiguration values for the HTTP service around {@link FkControl}.
 * Uses a create to create immutable instances.
 */
public class HttpServiceConfiguration {
  ...
  static final String DEFAULT_BASE_URL = "/signal-enhancement/fkcontrol/";
  ...
  /**
   * Constructs instances of {@link HttpServiceConfiguration} following the create pattern
   */
