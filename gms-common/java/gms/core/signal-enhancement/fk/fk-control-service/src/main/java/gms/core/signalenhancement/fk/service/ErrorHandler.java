...
public class ErrorHandler {
  ...
  public static StandardResponse handle400(String errorMessage) {
    Objects.requireNonNull(errorMessage,
        "ErrorHandler.handle400 requires non-null errorMessage");

    StringBuilder messageBuilder = new StringBuilder();
    messageBuilder.append("Error 400 - Bad Request");
    ...
    return StandardResponse.create(HttpStatus.BAD_REQUEST_400, messageBuilder.toString(),
        ContentType.TEXT_PLAIN);
  }

  /**
   * Creates a {@link StandardResponse} with a 404 status and json body listing the missing
   * resource
   *
