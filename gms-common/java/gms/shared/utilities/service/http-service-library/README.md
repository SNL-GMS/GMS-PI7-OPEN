...
## Transforming a `Request` into a `Response`: the [RequestHandler](java/gms/shared/utilities/service/http-service-library/src/main/java/gms/shared/utilities/service/RequestHandler.java) interface
