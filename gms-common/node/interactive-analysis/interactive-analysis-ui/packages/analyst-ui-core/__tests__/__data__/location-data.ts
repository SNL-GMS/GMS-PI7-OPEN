import { CommonTypes, EventTypes, SignalDetectionTypes } from '~graphql/';
import { CreatorType, PhaseType } from '~graphql/common/types';
import { DepthRestraintType, RestraintType, ScalingFactorType } from '~graphql/event/types';
import { FeatureMeasurementTypeName } from '~graphql/signal-detection/types';

export const mockDistanceToStations: any[] = [
    {
        stationId: 'fd3dbadc-72fd-36c6-a3cc-ca4f7a4f58be',
        distance: 5
    }, {
        stationId: '7a481f10-e4d3-3687-9efa-622a82eb92cf',
        distance: 13
    }
];
        ...
        locationBehaviors: [
          {
            ...
            featureMeasurementId: '693b34c9-c8a1-4420-85ac-2e98fd6f3676'
          },
          {
            residual: -1.4,
            weight: 1.01,
            defining: true,
            featurePredictionId: '00000000-0000-0000-0000-000000000000',
            featureMeasurementId: 'e3c2bc49-c29c-4995-bff8-7c871fe35813'
          },
          {
            residual: -0.4,
            weight: 1.01,
            defining: false,
            featurePredictionId: '00000000-0000-0000-0000-000000000000',
            featureMeasurementId: '0cdc74c5-54c5-493b-9a76-432fc237fbbc'
          }
        ]
      },
      creationInfo: {
          id: '1',
          creationTime: 1552431356.438,
          creatorId: 'creatorId',
