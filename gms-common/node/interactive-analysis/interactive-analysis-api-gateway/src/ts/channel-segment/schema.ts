/**
 * GraphQL schema definition for the Channel Segment API gateway
 */
...
export const schema = readFileSync(resolve(
    process.cwd(), 'resources/graphql/channel-segment/schema.graphql')).toString();
